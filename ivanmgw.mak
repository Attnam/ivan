...
CC       = g++ -o
FeLibDIR = F:\ivan\FeLib
FeLibGCH =
SDL2DIR = F:\ivan\SDL2-2.0.4\x86_64-w64-mingw32
...
#FLAGS = -DGCC -DUSE_SDL -DWIZARD -IInclude -I$(FeLibDIR)/Include -pg -O0 -ffast-math -march=athlon-xp -mwindows
FLAGS =  -I$(SDL2DIR)/include/SDL2 -L$(SDL2DIR)/lib
FLAGS += -DWIN32 -DGCC -DUSE_SDL -DWIZARD  -IInclude -I$(FeLibDIR)/Include -O0 -std=c++11 -ffast-math -s -W -Wall -pedantic -mwindows
