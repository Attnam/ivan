...
const char* locale::GetNameStem() const { return "pet graveyard filled with gravestones named Kenny"; } // needs to be databased asap
//v2 locale::GetBitmapPos(int) const { return v2(16, 64); } //same bitmap as for new attnam. Also needs to be abstracted away
int locale::GetAttachedDungeon() const { return LOCALE05; } // what to do? what to DO?
